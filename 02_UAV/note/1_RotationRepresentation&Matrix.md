...
- **第一行**：$0\cdot w + (-p)\cdot x + (-q)\cdot y + (-r)\cdot z$ $\rightarrow$ 正好等于上面展开的第1项。
- **第二行**：$p\cdot w + 0\cdot x + r\cdot y + (-q)\cdot z$ $\rightarrow$ 正好等于上面展开的第2项。
